        ...
        private void InitializeNodes()
        {
            ...
            foreach(var state in states)
            {
                foreach(var transition in state.State.TransitionsTo)
                {
                    ...
                    {
                        var edge = states.Find(s => s.NodeName == transition.OriginState.Name).Q<Port>(className: "output").ConnectTo<FSMC_Edge>(state.Q<Port>(className: "input"));
                        edge.transition = transition;
                        AddElement(edge);
                    }
                }
            ...
            {
                AddElement(Start.Q<Port>(className: "output").ConnectTo<FSMC_Edge>(states.Find(s=>s.NodeName==Controller.StartingState.Name).Q<Port>(className:"input")));
            }
        }
